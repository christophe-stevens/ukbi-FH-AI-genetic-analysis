...
export clinvarPatho="((dbNSFP_clinvar_clnsig has 'Pathogenic'  | dbNSFP_clinvar_clnsig has 'Pathogenic/Likely_pathogenic' | dbNSFP_clinvar_clnsig has 'Likely_pathogenic') & ANN[*].EFFECT!='stop_gained')"
...
# VUS
java -jar ./snpEff/SnpSift.jar filter "${clinvarTrait} & ${clinvarReview} & ${clinvarVUS}"  chr2.apob.snpEff.maf.dbNSFP.vcf > clinvar.vus.vcf;
# Remainer
java -jar ./snpEff/SnpSift.jar filter --inverse "${clinvarBenign}"  chr2.apob.snpEff.maf.dbNSFP.vcf  > remainer1.clinvar.vcf;
